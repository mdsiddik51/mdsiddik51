...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=36BCF7&center=true&vCenter=true&width=435&lines=3rd+Year+CST+Student;Full+Stack+Web+Developer;MERN+Stack+Enthusiast;Programming+Hero+Learner" alt="Typing SVG" />
  </a>
</p>
...
const developer = {
  ...
  technicalArsenal: {
    ...
    frontend: {
      core: ["HTML5", "CSS3", "React.js", "Next.js", "Vite"],
  ...
  mission:
    "Engineering the synergy between scalable system architecture and sophisticated UI/UX design.",
};
```
